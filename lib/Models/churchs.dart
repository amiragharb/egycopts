...
List<Churchs> churchsFromJson(String str) =>
    List<Churchs>.from(json.decode(str).map((x) => Churchs.fromJson(x)));

String churchsToJson(List<Churchs> data) =>
...
class Churchs {
  ...
  factory Churchs.fromJson(Map<String, dynamic> json) => Churchs(
        id: json["ID"] as int?,
