...
//
//     final calendarCourse = calendarCourseFromJson(jsonString);

import 'dart:convert';

List<CalendarCourse> calendarCourseFromJson(String str) =>
    List<CalendarCourse>.from(json.decode(str).map((x) => CalendarCourse.fromJson(x)));

String calendarCourseToJson(List<CalendarCourse> data) =>
...
class CalendarCourse {
  ...
  factory CalendarCourse.fromJson(Map<String, dynamic> json) => CalendarCourse(
        id: json["ID"] as int?,
